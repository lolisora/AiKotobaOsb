...
namespace StorybrewScripts
{
    public class Lyrics : StoryboardObjectGenerator
    {
        ...
        public string FontName = "UDDigiKyokashoN-R.ttc";
        ...
        public override void Generate()
        {
            ...
            foreach (var line in LoadSubtitles(SubtitlesPath).Lines)
            {
                ...
                var position = new Vector2(600 - texture.BaseWidth * FontScale * 0.5f, SubtitleY) 
                ...
                sprite.Fade(line.EndTime, line.EndTime + 200, 1, 0);
            }
        }
    }
}
